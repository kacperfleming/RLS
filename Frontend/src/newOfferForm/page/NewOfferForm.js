...
const NewOffer = props => {
    ...
    const {form, data} = useCustomForm({inputs: FORM_FIELDS, title: 'Stwórz ofertę', buttonText: 'DODAJ OFERTĘ', url: 'add-offer', method: 'POST', redirect: '/products/new', auth: true});
